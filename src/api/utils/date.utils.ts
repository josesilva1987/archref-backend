...
public static isFilteredDate(data:Date, filterParam: ISearchWithDateDto): boolean {
  if(DateUtils.isNotEmptyDate(filterParam?.firstDate) && DateUtils.isNotEmptyDate(filterParam.lastDate)){
